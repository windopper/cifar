...
from .deep_baseline3_bn_residual_15 import ResidualBlock
from .deep_baseline3_bn_residual_15_attention import (
...
class ResidualAttentionModel_92_32input_Tiny(nn.Module):
    """
    ...
    def __init__(self, init_weights: bool = False):
        super(ResidualAttentionModel_92_32input_Tiny, self).__init__()
...
def make_residual_attention_92_32input_tiny(init_weights: bool = False) -> ResidualAttentionModel_92_32input_Tiny:
    """
    ~10M 파라미터 수준의 경량 Residual Attention 모델을 생성.
    """
    return ResidualAttentionModel_92_32input_Tiny(init_weights=init_weights)


__all__ = [
    "ResidualAttentionModel_92_32input",
    "ResidualAttentionModel_92_32input_Tiny",
