"""
DeepBaselineNetBN3ResidualWide: DeepBaselineNetBN3Residual의 채널 수를 2배로 늘린 Wide 버전
...
class DeepBaselineNetBN3ResidualWide(nn.Module):
    """
    DeepBaselineNetBN3Residual의 채널 수를 2배로 늘린 Wide 버전
    ...
    def __init__(self, init_weights=False):
        super(DeepBaselineNetBN3ResidualWide, self).__init__()
