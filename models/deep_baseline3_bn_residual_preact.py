"""
DeepBaselineNetBN3ResidualPreAct: DeepBaselineNetBN3Residual의 Pre-activation 버전
...
class DeepBaselineNetBN3ResidualPreAct(nn.Module):
    """
    DeepBaselineNetBN3Residual의 Pre-activation 버전 네트워크
    ...
    def __init__(self, init_weights=False):
        super(DeepBaselineNetBN3ResidualPreAct, self).__init__()
