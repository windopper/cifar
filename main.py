...
def parse_args():
    ...
    parser.add_argument('--net', type=str, default='baseline',
                        choices=['baseline', 'baseline_bn', 'deep_baseline', 'deep_baseline_silu',
                                 ...
                                 'deep_baseline2_bn_residual_grn', 'deep_baseline3_bn_residual', 'deep_baseline3_bn_residual_preact', 'deep_baseline3_bn_residual_swish', 'deep_baseline3_bn_residual_swiglu', 
                                 'deep_baseline3_bn_residual_dla', 'deep_baseline3_bn_residual_dla_tree', 'deep_baseline3_bn_residual_group', 
                                 'deep_baseline3_bn_residual_mish', 'deep_baseline4_bn_residual',
